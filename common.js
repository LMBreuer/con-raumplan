...
const STRINGS = {
  de: {
    ...
    tourChooseConHint: "Klicke jetzt eine Con an – der Rundgang geht dort automatisch weiter.",
    ...
    tourPublicChooseBody: "Öffne die Con, an der du teilnimmst. Deine Auswahl bestimmt, welcher aktuelle Raum- und Tischplan geladen wird.",
  ...
  en: {
    ...
    tourChooseConHint: "Click a con now – the tour will continue there automatically.",
    ...
    tourPublicChooseBody: "Open the con you are attending. Your choice determines which current room and table plan is loaded.",
