...
const STRINGS = {
  de: {
    ...
    floorPlanCreatorTitle: "Lageplan-Creator", floorPlanCreatorHint: "Räume werden mit den vorhandenen Raumdaten verbunden und übernehmen Name, Farbe und Symbol automatisch.",
    ...
    floorPlanOrientation: "Seitenformat", floorPlanTitleLabel: "Titel", floorPlanTextLabel: "Text", floorPlanSymbolLabel: "Symbol", floorPlanObjectRoom: "Verknüpfter Raum",
    floorPlanUnlinkedRoom: "Nicht verknüpfter Raum", floorPlanOpenRoomAria: "Details für {name} öffnen", floorPlanNoRooms: "Lege zuerst unter Räume mindestens einen Raum an.",
  ...
  en: {
    ...
    floorPlanCreatorTitle: "Venue map creator", floorPlanCreatorHint: "Rooms are linked to existing room data and automatically inherit their name, colour and symbol.",
    ...
    floorPlanOrientation: "Page format", floorPlanTitleLabel: "Title", floorPlanTextLabel: "Text", floorPlanSymbolLabel: "Symbol", floorPlanObjectRoom: "Linked room",
    floorPlanUnlinkedRoom: "Unlinked room", floorPlanOpenRoomAria: "Open details for {name}", floorPlanNoRooms: "Create at least one room under Rooms first.",
