...
const STRINGS = {
  de: {
    ...
    floorPlanSaveTooLarge: "Der Lageplan ist zu groß zum Speichern. Bitte Elemente oder Ebenen reduzieren.", floorPlanSaveUnauthorized: "Die Lageplanbearbeitung ist derzeit nur für Superadmins freigeschaltet.",
    ...
    floorPlanOrientation: "Seitenformat", floorPlanTitleLabel: "Titel", floorPlanTextLabel: "Text", floorPlanSymbolLabel: "Symbol", floorPlanObjectRoom: "Raum",
    floorPlanUnlinkedRoom: "Nicht verknüpfter Raum", floorPlanCustomRoom: "Freier Raum", floorPlanCustomRoomDefault: "Neuer Raum", floorPlanRoomName: "Name", floorPlanRoomLocation: "Lage / Zusatzinfo", floorPlanRoomLocationPlaceholder: "z. B. 1. Stock links", floorPlanRoomColor: "Farbe", floorPlanRoomMarker: "Symbol", floorPlanOpenRoomAria: "Details für {name} öffnen", floorPlanNoRooms: "Noch keine verknüpfbaren Räume vorhanden. Freie Räume kannst du trotzdem zeichnen.",
  ...
  en: {
    ...
    floorPlanSaveTooLarge: "The venue map is too large to save. Please reduce its elements or floors.", floorPlanSaveUnauthorized: "Venue map editing is currently restricted to superadmins.",
    ...
    floorPlanOrientation: "Page format", floorPlanTitleLabel: "Title", floorPlanTextLabel: "Text", floorPlanSymbolLabel: "Symbol", floorPlanObjectRoom: "Room",
    floorPlanUnlinkedRoom: "Unlinked room", floorPlanCustomRoom: "Free room", floorPlanCustomRoomDefault: "New room", floorPlanRoomName: "Name", floorPlanRoomLocation: "Location / details", floorPlanRoomLocationPlaceholder: "e.g. 1st floor left", floorPlanRoomColor: "Colour", floorPlanRoomMarker: "Marker", floorPlanOpenRoomAria: "Open details for {name}", floorPlanNoRooms: "No rooms are available to link yet. You can still draw free rooms.",
